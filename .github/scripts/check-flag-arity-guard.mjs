...
// resolving it through pathToFileURL, which also normalizes a relative
...
// The shell surface `--all` walks: tracked *.sh / *.bash files, plus tracked
// extensionless files (git hooks under .hooks/, bin scripts) whose shebang is
// bash/sh.
function shellFiles() {
