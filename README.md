...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `ANTHROPIC_API_KEY`   | `claude`, `security-vulnerability-scan`, `auto-version`, `claude-pr-review`, `claude-review-thread-resolve`, `pr-desc-accuracy` | For Claude-backed workflows                                                 |
